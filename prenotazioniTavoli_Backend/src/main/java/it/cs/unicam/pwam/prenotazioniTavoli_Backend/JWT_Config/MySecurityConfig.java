package it.cs.unicam.pwam.prenotazioniTavoli_Backend.JWT_Config;
...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private CustomClienteDetailsService customUserDetailsService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/tokenLogin","/getUsernameByToken","/tokenInsertCliente","/tokenInsertPrenotazione").permitAll()
